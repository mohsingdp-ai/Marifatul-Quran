(function () {
  ...
  var SEEK_BACK_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11.99 5V1l-5 5 5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6"/><text x="12" y="16.5" text-anchor="middle" font-size="7" font-weight="600" fill="currentColor" stroke="none" font-family="sans-serif">5</text></svg>';
  var SEEK_FWD_SVG  = '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12.01 5V1l5 5-5 5V7c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6"/><text x="12" y="16.5" text-anchor="middle" font-size="7" font-weight="600" fill="currentColor" stroke="none" font-family="sans-serif">5</text></svg>';
